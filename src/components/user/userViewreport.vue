            ...
            <div class="mt-10 col-lg-12">
                <div>
                                            ...
                                            <h6 class="SendrName">
                                                <span>
                                                    <v-avatar color="orange" size="48">
                                                        <span class="white--text text-h5">{{replymessage.avatar}}</span>
                                                    </v-avatar>
                                                    <span class="ml-4">
                                                        {{ replymessage.user }}
                                                    </span>
                    ...
                    <!-- <div class="text-center">
                        <v-dialog v-model="dialogRemark" width="500">
                            <template v-slot:activator="{ on, attrs }">
                                <button class="sendRequest2" v-bind="attrs" v-on="on">Remark</button>
                            </template>
                            ...
                            <v-card>
                                ...
                                <v-container>
                                    <v-row>
                                        <v-col cols="12" sm="12" md="12">
                                            <v-textarea clearable clear-icon="mdi-close-circle" label="Remark"
                                                v-model="remarkValue"></v-textarea>
                                        </v-col>
                                    </v-row>
                                </v-container>
                                <v-card-actions>
                                    ...
                                    <v-btn color="primary" text @click="saveRemark">
                                        Submit
                                    </v-btn>
                                </v-card-actions>
                            </v-card>
...
export default {
    ...
    methods: {
        ...
        async getremarks() {
            ...
            await axios.get(`http://localhost:3000/api/v1/review/adminRemark/remark/${item}`,
                ...
                .then((response) => {
                    ...
                    // var newDate = new Date(this.messages.reportdate);
                    // this.formattedDate = monthNames[newDate.getMonth()] + ' ' + newDate.getFullYear();
                ...
                .then((response) => {
                    ...
                    response.data.data.replys.forEach(elem => {
                        replymessages2.push({
                            ...
                            showreplyBoxrrr: false,
                            // replyofRemark: elem.replyofRemark,
                            // replyofRemarkuser: elem.replyofRemark.remarkBy
                            // remarkBy: elem.remarkBy.firstName + " " + elem.remarkBy.lastName,
                            // // dateCreated: elem.createdAt.split("T")[0],
                            // category: elem.remarkBy.category,
                        })
        ...
        //     } else {
        //         // console.log(this.userID);
        //         await axios.post(`http://localhost:3000/api/v1/review/userReply/replies/${reportId}`,
        //             {
        //                 reply: this.bio,
        //                 replybutton: 'Reply'
        //             },
        ...
        //         // await axios.post(`http://localhost:3000/api/v1/review/notification/notification`,
        //         //     {
        //         //         report: reportId,
        //         //         createdBy: RuserId
        //         //     },
            ...
            if (this.bio === '') {
                ...
                await axios.post(`http://localhost:3000/api/v1/review/adminRemark/remarks/${reportId}`,
                    ...
                    .then((response) => {
                        ...
                        this.getremarks()
                        this.bio = '';
                        // this.remarkID = response.data.data.remark._id
                        // const remarkId = this.remarkID
                        // localStorage.setItem('remarkId', JSON.stringify(remarkId));
