        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="cnt" style="">
                    <div class="textD">
                        <div>
                            <span style="font-size: 8rem; color: #21618C"><i class="fas fa-paste"></i></span>
                        </div>
                        <div>
                            <h6 style="color: #21618C" class="numbertxt">{{ reports }}</h6>
                            <p style="color: #21618C" class="numbertxt2">Reports</p>
                        </div>
                    </div>
                    <div class="textD">
                        <div>
                            <span style="font-size: 8rem; color: #21618C"><i class="fas fa-users"></i></span>
                        </div>
                        <div>
                            <h6 style="color: #21618C" class="numbertxt">{{ users }}</h6>
                            <p style="color: #21618C" class="numbertxt2">Users</p>
                        </div>
                    </div>
                    <div class="textD">
                        <div>
                            <span style="font-size: 8rem; color: #21618C"><i class="fas fa-file-alt"></i></span>
                        </div>
                        <div>
                            <h6 style="color: #21618C" class="numbertxt">{{ logs }}</h6>
                            <p style="color: #21618C" class="numbertxt2">Logs</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    data: () => ({
        ...
        chartOptions: {
            ...
            labels: ['Users', 'Report', 'Facebook', 'LinkedIn'],
            legend: {
                show: true,
                floating: true,
                fontSize: '18px',
    ...
    async beforeMount() {
        ...
        await axios.all([
            ...
            axios.get('http://localhost:3000/api/v1/review/logRoute/logs', {
                headers: {
                    'token': `Bearer ${token}`
                }
            }),
            axios.get('http://localhost:3000/api/v1/review/report/allReport', {
                headers: {
                    'token': `Bearer ${token}`
                }
            }),
            ...
            .then(axios.spread((response1, response2, response3) => {
                this.users = response1.data.data.nbHits
                this.logs = response2.data.data.nbHits
                this.reports = response3.data.data.nbHits
                // this.competedR = response4.data.data.nbHits
                console.log(response3.data.data);
                response3.data.data.reviews.forEach(elem => {
                    this.desserts.push({
                        itemId: elem._id,
                        createdById: elem.createdBy._id,
